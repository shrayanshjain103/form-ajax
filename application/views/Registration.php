...
.form-input {
    width: 100%;
    padding: 12px;
    border: 1px solid #FF5C8E; /* Input border color */
    border-radius: 5px;
    font-size: 16px;
...
.form-input:focus {
    border-color: #FF495E; /* Input border color on focus */
}
...
.form-button {
    background-color: #FF5C8E; /* Button background color */
...
.form-button:hover {
    background-color: #FF495E; /* Change button color on hover */
}
...
.form-link:hover {
    color: #FF5C8E; /* Change link color on hover */
}
</style>
<body>
<!DOCTYPE html>
